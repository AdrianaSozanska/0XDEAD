...
const MAP_DATA = [
  {
    ...
    outlineAspect: 0.799,
    streets: [
      { id: "ternopil-1", name: "Тернопільський став", address: "Розділ 0x30", photo: "assets/img/Тернопільстав_new.jpeg", x: 37.5, y: 49.0, note: "" },
      { id: "ternopil-2", name: "Підволочиське шосе, 5", address: "Розділ 0x29", photo: "assets/img/Тернопільквартира_new.jpeg", x: 90, y: 49.0, note: "" }
    ]
  },
  {
    id: "vinnytsia",
    ...
    outlineAspect: 1.453,
    streets: [
      { id: "vinnytsia-1", name: "вулиця Монастирська, 41", address: "Розділ 0x32", photo: "assets/img/Вінницяквартира_new.jpeg", x: 51.1, y: 54.1, note: "" }
    ]
  },
  {
    id: "kyiv",
